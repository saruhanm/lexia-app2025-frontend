...
const emit = defineEmits(['login-success', 'signup-success', 'google-login-success'])
...
const handleGoogleLogin = async () => {
  try {
    ...
    if (googleUser) {
      ...
      emit('google-login-success', googleUser)
    }
  } catch (error) {
...
const handleSignup = async () => {
  try {
    ...
    // Emit success event to parent
    emit('signup-success', signupForm.value)
    ...
    <div class="w-full max-w-sm mx-auto flex flex-col">
      ...
      <div class="flex-1 flex flex-col items-center justify-center px-4 pb-8">
        ...
        <div class="text-center mb-8">
          <div class="mb-6">
            <h1 class="text-2xl font-light mb-2 text-gray-700">Welcome to</h1>
            <h2 class="text-4xl font-bold tracking-wider bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">LEXIA</h2>
          </div>
        ...
        <div class="w-full">
          ...
          <div v-if="!showSignup" class="bg-white rounded-2xl shadow-xl shadow-blue-100/50 p-6 space-y-6">
            <div class="text-center mb-6">
              <h3 class="text-xl font-semibold text-gray-800 mb-2">Sign In</h3>
        ...
        <div class="mt-8 text-center">
          <p class="text-xs text-gray-500 mb-2">Trusted by thousands of readers worldwide</p>
          <div class="flex items-center justify-center space-x-4">
            ...
            <div class="text-xs text-gray-600">50k+ downloads</div>
            <div class="text-xs text-gray-500">•</div>
            <div class="text-xs text-gray-600">Privacy focused</div>
          </div>
        </div>
      </div>
    </div>
