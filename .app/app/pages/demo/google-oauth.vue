  ...
  <div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-2xl mx-auto px-4">
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Google OAuth Demo</h1>
        <p class="text-gray-600">Test the Google authentication integration</p>
      </div>
      ...
      <div v-if="user" class="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
        <div class="flex items-center mb-4">
          ...
          <div class="ml-4">
            <h3 class="text-lg font-medium text-green-900">Welcome, {{ user.name }}!</h3>
      ...
      <div v-else class="bg-white rounded-lg shadow-md p-6 mb-8">
        <h2 class="text-xl font-semibold mb-4">Try Google Login</h2>
      ...
      <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
        <h3 class="text-lg font-medium text-blue-900 mb-3">Integration Details</h3>
